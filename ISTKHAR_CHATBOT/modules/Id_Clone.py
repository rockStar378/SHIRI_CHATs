...
from ISTKHAR_CHATBOT import ISTKHAR_CHATBOT as app, save_clonebot_owner, save_idclonebot_owner
from ISTKHAR_CHATBOT import ISTKHAR_CHATBOT, db as mongodb
...
async def delete_cloned_session(client, message):
    try:
        ...
        if cloned_session:
            ...
            await ok.edit_text(
                f"**Your String Session has been removed from my database ✅.**\n\n**Your bot will off after restart @{ISTKHAR_CHATBOT.username}**"
            )
        else:
